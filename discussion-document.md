...
- **Refinement** of estimates and assumptions
- **Counterarguments** where perspectives have been missed
- **Expert input** from the organisations and individuals named above
...
- **Clover nitrogen fixation** (biological, variable, climate-dependent)
- **Synthetic nitrogen application** (controllable, predictable, high-intensity)
...
- **Pasture systems:** Reduced nitrogen reduces growth rates within weeks; full carrying capacity loss over 1-3 months
- **Cropping systems:** Seasonal; a crop planted without adequate nitrogen fails at harvest, 3-6 months after application decision
- **Perennial horticulture (e.g., orchards, vineyards):** Multi-year; nitrogen stress in one season affects yield in subsequent seasons
...
- 10% in year one ($5-5.5 billion)
- 20% in year two ($10-11 billion, as supply chains reorient)
- Sustained 15-20% reduction thereafter
...
- Agronomists and crop scientists on New Zealand-specific nitrogen-yield curves
- Agricultural economists on sectoral GDP elasticities
- Pastoral system specialists on clover fixation limits under high-intensity farming
...
- **The Māui field ceases production in 2027**
- **Methanex and Ballance exit the gas market in the same year**
...
- Ravensdown COO Mike Whitty: "In the shorter term, there's nothing to be concerned about from a supply point of view"
- Ballance CEO Kelvin Wickham: "Upcoming shipments are mostly subject to pricing at time of shipment"

**But medium-term risks remain** ○:

- Federated Farmers arable chair David Birkett: "The key word at the moment is uncertainty because we don't know how long this is going to go on for"
- If the conflict continues, spring application (starting August-September) could be severely impacted
- **Structural damage to Qatari and Iranian production** (if confirmed) means even immediate ceasefire would not restore full supply for years
...
**Trigger conditions:**
- Strait of Hormuz reopens within 3-6 months
- Qatari and Iranian production resumes within 12 months (partial capacity)
- Kapuni plant operates normally (gas available at affordable prices)
- Global fertilizer prices remain elevated (+20-30%) but supply flows
...
- Domestic food price inflation: +3-5% (transient)
- Farmgate milk price reduction: -5-10%
- Rural unemployment: modest increase (1-2%)
- Tax revenue loss: $200-500 million per year at peak

### 3.4 Scenario 2: Moderate Disruption □

**Trigger conditions:**
- Strait of Hormuz remains contested for 12-24 months
- Qatari production offline for 2-3 years (Ras Laffan repairs)
- Iranian production offline for 3-5 years (South Pars structural damage)
- Global fertilizer prices sustained +50-100%
- Kapuni plant operates intermittently (3-4 month shutdowns annually)
- New Zealand competes for spot imports at elevated prices
...
**Other economic effects (illustrative):**
- Domestic food price inflation: +10-20% (sustained)
- Farmgate milk price reduction: -15-25%
- Rural unemployment: significant increase (5-10%)
- Farm insolvencies: widespread in marginal operations
- Tax revenue loss: $1-2 billion per year at peak

### 3.5 Scenario 3: Severe Disruption □

**Trigger conditions:**
- Strait of Hormuz effectively closed indefinitely (2+ years)
- Qatari production offline for 5+ years (major structural damage)
- Iranian production offline for 7-10 years (severe infrastructure destruction)
- Other Gulf producers (UAE, Kuwait) also disrupted by escalation
- Chinese export restrictions remain in place
- Global fertilizer market structurally reorients (permanently higher prices, reallocated supply)
- Kapuni plant shut down permanently (gas unaffordable or unavailable)
- New Zealand unable to secure sufficient imports at any price
...
**Other economic effects (illustrative):**
- Domestic food price inflation: +20-40% (severe, sustained)
- Farmgate milk price reduction: -30-50% (collapse)
- Rural unemployment: catastrophic (20-30%+)
- Widespread farm and agribusiness insolvencies
- Tax revenue loss: $2-4 billion per year at peak
- Broader economic recession (agricultural contraction cascading through transport, processing, retail, finance)
...
- Direct agricultural export loss: $8-12 billion
- Downstream economic loss: $2.5-6 billion
- **Total economic impact: $10.5-18 billion**
...
- Unemployment benefits (rural)
- Regional development assistance
- Farm support packages (political pressure)
...
- Modular green ammonia plants delivered in **2-3 years** (vs. 7-12 years for traditional Western EPC)
- Experience with variable renewable integration (wind/solar/hydro hybrid)
- Lower capital costs due to mature domestic supply chains
- Willingness to export technology (subject to export controls and financing)
...
- **Dedicated geothermal or hydro** for baseload hydrogen production (60-70% of demand)
- **Grid wind/hydro** for variable top-up (30-40%)
- **Minimal battery storage** (using hydro lakes as natural batteries)
...
**Total regulatory timeline (optimistic): 18-24 months**
**Total regulatory timeline (realistic, with appeals): 24-36 months**
...
- **Fast-track consenting** (under COVID-19 Recovery or similar legislation) – politically sensitive but possible
- **Designation as a project of national significance** (under Resource Management Act)
- **Use of existing industrial sites** (e.g., Kapuni) to reduce greenfield consenting requirements
- **Parallel consenting and construction** (risk: consent denial after construction begins)
...
- Consenting and regulatory approvals occur in parallel with construction (risk: consent denial)
- No significant appeals or legal challenges
- Chinese EPC delivers on schedule (track record supports 2-3 years, but NZ conditions may differ)
- No major supply chain disruptions
- Financing available at reasonable terms
...
- Correction of factual errors (GDP share, urea import dependency)
- Morão positioned as analogous support, not direct validation
- Distinction between direct and downstream economic effects
- Reframed war narrative as dated chronology
- LNG scarcity as plausible risk, not certainty
- Clarified green ammonia scope
- Effective N equivalents throughout
- Reader's Guide with geometric symbols (◆ ◇ □ ○)
- Complete reference list
- Appendix of assumptions to be challenged
